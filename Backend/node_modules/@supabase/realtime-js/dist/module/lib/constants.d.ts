import type { SocketState, ChannelState, ChannelEvent as PhoenixChannelEvent, Transport, Vsn } from '@supabase/realtime-js/src/phoenix/types';
export type { SocketState, ChannelState, Transport };
export declare const DEFAULT_VERSION = "realtime-js/2.106.0";
export declare const VSN_1_0_0: Vsn;
export declare const VSN_2_0_0: Vsn;
export declare const DEFAULT_VSN: Vsn;
export declare const VERSION = "2.106.0";
